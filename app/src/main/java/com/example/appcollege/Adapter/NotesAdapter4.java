...
import com.example.appcollege.User.NotesDetails4;

import java.util.ArrayList;

public class NotesAdapter4 extends RecyclerView.Adapter<NotesAdapter4.NotesViewHolder4>
{
    private Context _context;
    private ArrayList<NotesData> _list;

    public NotesAdapter4(Context _context, ArrayList<NotesData> _list)
    {
    ...
    @NonNull
    @Override
    public NotesViewHolder4 onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View _view = LayoutInflater.from(parent.getContext()).inflate(R.layout.subjectsfeed_item, parent, false);

        return new NotesViewHolder4(_view);
    }

    @Override
    public void onBindViewHolder(@NonNull NotesViewHolder4 holder, int position)
    {
        ...
        holder._cardView.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent _intent = new Intent(_context, NotesDetails4.class);
    ...
    public class NotesViewHolder4 extends RecyclerView.ViewHolder
    {
        ...
        public NotesViewHolder4(@NonNull View itemView)
        {
            super(itemView);
