...
public class NotesAdd2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notes_add2);

        _notesTitle = findViewById(R.id.notes_add_title2);
        _notesDescription = findViewById(R.id.notes_add_Notes2);
        _notesAddButton = findViewById(R.id.notes_add_button2);
    ...
    private void uploadData()
    {
        ...
        _thirdRef.child("Sub2").child(_uniqueKey).setValue(_notesData).addOnSuccessListener(new OnSuccessListener<Void>()
        {
            @Override
            public void onSuccess(Void aVoid)
            {
                _dialog.dismiss();
                Toast.makeText(NotesAdd2.this, "New notes added!", Toast.LENGTH_SHORT).show();

                Intent _intent = new Intent(NotesAdd2.this, NotesManage.class);
        ...
        }).addOnFailureListener(new OnFailureListener()
        {
            ...
            {
                _dialog.dismiss();
                Toast.makeText(NotesAdd2.this, "Something went wrong! Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}