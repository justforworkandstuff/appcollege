...
public class NotesAdd extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        _notesTitle = findViewById(R.id.notes_add_title);
        _notesDescription = findViewById(R.id.notes_add_Notes);
        _notesAddButton = findViewById(R.id.notes_add_button);
    ...
    private void uploadData()
    {
        ...
        _thirdRef.child("Sub1").child(_uniqueKey).setValue(_notesData).addOnSuccessListener(new OnSuccessListener<Void>()
        {
            @Override
            public void onSuccess(Void aVoid)
            {
                _dialog.dismiss();
                Toast.makeText(NotesAdd.this, "New notes added!", Toast.LENGTH_SHORT).show();

                Intent _intent = new Intent(NotesAdd.this, NotesManage.class);
        ...
        }).addOnFailureListener(new OnFailureListener()
        {
            ...
            {
                _dialog.dismiss();
                Toast.makeText(NotesAdd.this, "Something went wrong! Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
