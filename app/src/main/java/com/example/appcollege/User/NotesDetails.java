...
public class NotesDetails extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        _notesTitle = findViewById(R.id.notes_details_title);
        _notesDescription = findViewById(R.id.notes_details_notes);
        _notesDate = findViewById(R.id.notes_details_date);
        _notesTime = findViewById(R.id.notes_details_time);
        _saveButton = findViewById(R.id.notes_details_saveButton);
        _deleteButton = findViewById(R.id.notes_details_deleteButton);
        ...
        else
        {
            ...
            _fourthRef.child(_key).updateChildren(_hm).addOnCompleteListener(new OnCompleteListener()
            {
                ...
                public void onComplete(@NonNull Task task)
                {
                    ...
                    {
                        Toast.makeText(NotesDetails.this, "Note has been updated successfully.", Toast.LENGTH_SHORT).show();
                        Intent _intent = new Intent(NotesDetails.this, NotesManage.class);
                        startActivity(_intent);
                        finish();
                    }
                    else
                    {
                        Toast.makeText(NotesDetails.this, "Something went wrong, please try again.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    {
        AlertDialog.Builder _builder = new AlertDialog.Builder(NotesDetails.this);
            ...
            public void onClick(DialogInterface dialog, int id)
            {
                ...
                _fourthRef.child(_key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            Toast.makeText(NotesDetails.this, "Error, please try again later.", Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener()
                {
                    ...
                    {
                        Toast.makeText(NotesDetails.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
