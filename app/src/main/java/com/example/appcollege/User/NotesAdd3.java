...
public class NotesAdd3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notes_add3);

        _notesTitle = findViewById(R.id.notes_add_title3);
        _notesDescription = findViewById(R.id.notes_add_Notes3);
        _notesAddButton = findViewById(R.id.notes_add_button3);
    ...
    private void uploadData()
    {
        ...
        _thirdRef.child("Sub3").child(_uniqueKey).setValue(_notesData).addOnSuccessListener(new OnSuccessListener<Void>()
        {
            @Override
            public void onSuccess(Void aVoid)
            {
                _dialog.dismiss();
                Toast.makeText(NotesAdd3.this, "New notes added!", Toast.LENGTH_SHORT).show();

                Intent _intent = new Intent(NotesAdd3.this, NotesManage.class);
        ...
        }).addOnFailureListener(new OnFailureListener()
        {
            ...
            {
                _dialog.dismiss();
                Toast.makeText(NotesAdd3.this, "Something went wrong! Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}