...
public class NotesDetails2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notes_details2);
        ...
        _notesTitle = findViewById(R.id.notes_details_title2);
        _notesDescription = findViewById(R.id.notes_details_notes2);
        _notesDate = findViewById(R.id.notes_details_date2);
        _notesTime = findViewById(R.id.notes_details_time2);
        _saveButton = findViewById(R.id.notes_details_saveButton2);
        _deleteButton = findViewById(R.id.notes_details_deleteButton2);
        ...
        else
        {
            ...
            _fourthRef.child(_key).updateChildren(_hm).addOnCompleteListener(new OnCompleteListener()
            {
                ...
                public void onComplete(@NonNull Task task)
                {
                    ...
                    {
                        Toast.makeText(NotesDetails2.this, "Note has been updated successfully.", Toast.LENGTH_SHORT).show();
                        Intent _intent = new Intent(NotesDetails2.this, NotesManage.class);
                        startActivity(_intent);
                        finish();
                    }
                    else
                    {
                        Toast.makeText(NotesDetails2.this, "Something went wrong, please try again.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    {
        AlertDialog.Builder _builder = new AlertDialog.Builder(NotesDetails2.this);
            ...
            public void onClick(DialogInterface dialog, int id)
            {
                ...
                _fourthRef.child(_key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if(task.isSuccessful())
                        {
                            Toast.makeText(NotesDetails2.this, "Note deleted successfully.", Toast.LENGTH_SHORT).show();
                            Intent _intent = new Intent(NotesDetails2.this, NotesManage.class);
                        ...
                        {
                            Toast.makeText(NotesDetails2.this, "Error, please try again later.", Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener()
                {
                    ...
                    {
                        Toast.makeText(NotesDetails2.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
